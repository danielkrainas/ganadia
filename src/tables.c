...
/*	if ( !str_cmp( name, "do_opentourney" ))	return do_opentourney; */
	...
	if ( !str_cmp( name, "do_search" ))		return do_search;
        if ( !str_cmp( name, "do_secondweapon" ))       return do_secondweapon;
	...
	if ( !str_cmp( name, "do_tell" ))		return do_tell;
        if ( !str_cmp( name, "do_thirdweapon" ))        return do_thirdweapon;
...
char *skill_name( DO_FUN *skill )
{
    ...
    if ( skill == do_firstweapon )      return "do_firstweapon";
    if ( skill == do_secondweapon )     return "do_secondweapon";
    if ( skill == do_thirdweapon )      return "do_thirdweapon";
